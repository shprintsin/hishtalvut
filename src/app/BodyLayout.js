    ...
    <div className="flex flex-col min-h-screen p-0 m-0">
      <main className="flex-grow">
        ...
        <div className="sm:bg-prime flex justify-center sm:w-1/5 sm:border-l-2 align-middle items-center">       
          <Link href={""}>
          <Image alt="logo" src="/logo.png" width="180" height="140" />
          </Link>
          </div>
        ...
        <MainNav MainMenuData={data.MainMenu}/>
          ...
          <div className='sm:hidden flex justify-end'>
            <DropdownMenuTrigger>
            <button className="h-9 w-9 rounded justify-center align-middle flex items-center text-white">
            ...
            <DropdownMenuContent className="w-56" align="start">
              <DropdownMenuGroup>
                ...
                {data.MainMenu.map((item, index) => (
                  <DropdownMenuItem  className={"align-text justify-end"} key={index}>
                              <DropdownMenuItem className={"justify-end"}>
                                <Link href={item.uri} className=" flex justify-center align-middle gap-2 items-center  text-lg font-medium">
          ...
          {/* Icob */}
                ...
                <DropdownMenuItem className={"justify-end"}><Link href="/login" className=" flex justify-center align-middle gap-2 items-center  text-lg font-medium">
          <span>התחברות</span>
          <FaUser />
        </Link>
        </DropdownMenuItem>
        ...
        <div className='flex w-full sm:w-4/5 min-h-screen'>
        {children}
        </div>
        </div>
      </main>
